...
proc save_bookmarks {name} {
	...
	if {[catch {
		...
		error "Error al grabar a $fullname: $errorText"
	}
	return "Marcadores guardados con exito en $fullname"
}
...
proc load_bookmarks {name} {
	...
	if {[catch {
		...
		error "Error al cargar de $fullname: $errorText"
	}

	return "Cargado con exito $fullname"
}
